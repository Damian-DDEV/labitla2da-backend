...
const ticketsCore = {
    ...
    createTicket: async (ticket) => {
        ...
        if (ticketCreated) {
            const mailOptions = {
                from: "Remitente",
                subject: "Ticket Cinemaland",
                to: `damianmarquesa@gmail.com`,
                text: `Te agradecemos por elegirnos y confiar en nosotros, este ticket solo debe presentarse en boletería y la persona le indicará donde se encuentra su sala.
                Muchas gracias y disfrute de la experiencia Cinemaland.`,
                html: `<!DOCTYPE html>
                <html lang="en">
                  <head>
                    <meta charset="UTF-8" />
                    ...
                    <style>
                      ...
                      .barcode {
                        ...
                        box-shadow: 1px 0 0 1px #343434, 5px 0 0 1px #343434,
                          10px 0 0 1px #343434, 11px 0 0 1px #343434, 15px 0 0 1px #343434,
                          18px 0 0 1px #343434, 22px 0 0 1px #343434, 23px 0 0 1px #343434,
                          26px 0 0 1px #343434, 30px 0 0 1px #343434, 35px 0 0 1px #343434,
                          37px 0 0 1px #343434, 41px 0 0 1px #343434, 44px 0 0 1px #343434,
                          47px 0 0 1px #343434, 51px 0 0 1px #343434, 56px 0 0 1px #343434,
                          59px 0 0 1px #343434, 64px 0 0 1px #343434, 68px 0 0 1px #343434,
                          72px 0 0 1px #343434, 74px 0 0 1px #343434, 77px 0 0 1px #343434,
                          81px 0 0 1px #343434;
                      }
                    </style>
                  </head>
                  <body>
                    <div class="cardWrap">
                      <div class="card cardLeft">
                        ...
                        <div class="title">
                          <span>Película</span>
                          <h2>${ticketCreated.movie}</h2>
                        </div>
                        <div class="name">
                          <span>Sala</span>
                          <h2>${ticketCreated.theater}</h2>
                          <span>DNI</span>
                          <h2>${ticketCreated.dni}</h2>
                        </div>
                      </div>
